...
class BabyController extends Controller
{
    ...
    {
        $baby =$this->getDoctrine()->getRepository(Baby::class)
            ->find($id);
        $form=$this->createForm(BabyType::class,$baby);
        $form->handleRequest($request);
        ...
        return $this->render('baby/edit.html.twig',["form"=>$form->createView(),
            'baby'=>$baby]);
    ...
    public function delete($id, Request $request)
    {
        ...
        return $this->render('baby/delete.html.twig',["form"=>$form->createView(),
            'baby'=>$baby]);
    }
}
